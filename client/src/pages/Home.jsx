    ...
    return (
        <section className="max-w-7xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Browse through a collection of imaginative and visually stunning images generated with PromptCraft</p>
            </div>
